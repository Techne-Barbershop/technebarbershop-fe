...
import type { Staff, StaffResponse, StaffSchedule, StaffLeave, StaffLeavesResponse } from "@/lib/types/admin";
...
export default function StafPage() {
  ...
  const updateScheduleBlock = (index: number, field: keyof ScheduleInput, value: any) => {
